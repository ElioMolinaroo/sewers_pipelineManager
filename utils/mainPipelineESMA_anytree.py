...
def preProd(parent_node):
    ...
    node7 = Node('02_storyboom', parent=parent_node)
    Node('edit', parent=node7)
    Node('publish', parent=node7)
    node8 = Node('03_fond_forme', parent=parent_node)
    Node('edit', parent=node8)
    Node('publish', parent=node8)
    node9 = Node('04_lumascript', parent=parent_node)
    Node('edit', parent=node9)
    Node('publish', parent=node9)
    node10 = Node('05_colorscript', parent=parent_node)
    Node('edit', parent=node10)
    Node('publish', parent=node10)
    node11 = Node('06_key_shot', parent=parent_node)
    Node('edit', parent=node11)
    Node('publish', parent=node11)
    node12 = Node('07_concept_design', parent=parent_node)
...
def shot(parent_node):
    ...
    Node('_master_camera_', parent=parent_node)
    Node('_master_layout', parent=parent_node)
